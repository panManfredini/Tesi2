...
\begin{figure}[tp]
     \begin{center}
     \subfigure[]{		
            \includegraphics[height=3.cm]{feyn_diagrams/diagrams/bbA.pdf}
     }\hspace{0.2cm}	
     \subfigure[]{		
            \includegraphics[height=3.cm]{feyn_diagrams/diagrams/bbA2.pdf}
     }	\hspace{0.2cm}	
     \subfigure[]{		
            \includegraphics[height=2.5cm]{feyn_diagrams/diagrams/bbA3.pdf}
     }
     \subfigure[]{	
            \includegraphics[height=2.5cm]{feyn_diagrams/diagrams/ggH.pdf}
	}	
     \end{center}
