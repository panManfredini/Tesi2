...
\def\Ztautau{\ensuremath{Z\rightarrow \tau\tau}\xspace}
\def\Ztt{\ensuremath{Z\rightarrow \tau\tau}\xspace}
\def\Wlnu{\ensuremath{W\rightarrow l\nu}\xspace}
\def\Zll{\ensuremath{Z\rightarrow ll}\xspace}
\def\nqcd{\ensuremath{n^{QCD}}\xspace}
\def\rqcd{\ensuremath{R_{QCD}}\xspace}
\def\ToTauTauLepHad{\ensuremath{\rightarrow\tau\tau\to l\tau_{had}}\xspace}
\def\ToTauTauLepLep{\ensuremath{\rightarrow\tau\tau\to \tau_{l}\tau_{l}}\xspace}
...
\def\SumLtMET{\ensuremath{\sum L_{T} + \met} }
...
%% bg estimation:
%\input{bg_estimation}
%\input{bg_estimation_embedding}
%\clearpage
%\input{distributions}
%\clearpage
%%%
%\input{systematics}
%\input{exclusionlimits}
%\input{summary}
...
\input{appendix_presel.tex}
%%\input{appendix_signal}
