...
\documentclass[BCOR=20mm,DIV=15,fontsize=12pt,parskip=half,twoside,headsepline,headinclude,captions=nooneline,bibliography=totoc,listof=totoc,english]{scrbook}
...
\begin{dedica}
\begin{small}
\emph{To my friends of Munich:}\\\vspace{2mm}
Sebastian N., Sebastian P. \\
Takeshi T., Shang-yu S.,\\
Ana S.B., Marlene E.\\
Sergey A.
\end{small}
...
\input{detector}
\input{obj_reconstruction}

%analysis
\input{a_strategy}
\input{a_bkg_modeling}
\input{a_sys}
\input{a_result}
...
\appendix
\input{appendix_qcd}
\input{appendix_limit}

%\input{appendix_additional}
%\input{appendix_shapeNPs}
\end{appendices}
