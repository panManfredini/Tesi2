...
\subsection{Expected and Observed Events}
\begin{figure}[!t]
     \begin{center}
%    \subfigure[]{		
...
%	    \label{fullveto2}	
    	%\caption{\footnotesize full b-vetoed ed.}
   %  }	
...
The exclusion limits in the $m_A - \tan\beta$ parameter space  of the MSSM  $m_{h}^{mod}$ benchmark scenario
...
\begin{figure}[!h]
     \begin{center}
            \includegraphics[ width=0.55\textwidth]{figure/paper/limit_comb_2d_all.pdf}
    \end{center}
...
\begin{figure}[!t]
    ...
    \subfigure[$pp \rightarrow b(b)\phi$]{		
            \includegraphics[width=0.6\textwidth]{figure/paper/limit_comb_xs_bbA.pdf}
	}
    \subfigure[$gg \rightarrow\phi$]{		
            \includegraphics[ width=0.6\textwidth]{figure/paper/limit_comb_xs_ggA.pdf}
	}
     \end{center}
